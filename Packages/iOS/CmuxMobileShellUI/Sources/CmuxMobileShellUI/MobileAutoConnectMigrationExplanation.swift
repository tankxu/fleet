...
struct MobileAutoConnectMigrationExplanation: View {
    ...
    private var title: some View {
        Text(L10n.string(
            ...
            defaultValue: "Check Fleet on your Mac"
        ))
        .font(.title.bold())
    ...
    private var bodyText: some View {
        Text(L10n.string(
            ...
            defaultValue: "Auto-Connect needs Fleet 0.64.20 or later on your Mac for its authenticated, end-to-end encrypted connection."
        ))
        .font(.body)
    ...
    private var guidance: some View {
        Text(L10n.string(
            ...
            defaultValue: "Fleet 0.64.17 still works over Tailscale. Choose Connect iPhone/iPad on that Mac and scan its Pair iPhone code once."
        ))
        .font(.body)
